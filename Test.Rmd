...
```{r}
medicalCostsMen = round(rnorm(mean = 31248, sd = 1000, n = length(id)),2)
medicalCostsMen = round(medicalCosts*costDat$maleServed,2)
length(medicalCostsMen)
length(timeClients)
...
benefitsMedicalMen = sum(benefitsMedicalMen); benefitsMedicalMen

medicalCostsWomen  = round(rnorm(mean = 5000, sd = 1000, n = length(id)),2)
...
totalBenefits = sum(benefitsWagesRate, benefitsWagesWomen, benefitsMedicalWomen, benefitsMedicalRate)
```
